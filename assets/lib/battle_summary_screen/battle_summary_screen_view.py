...
class BattleSummaryScreenView(GameObject):

    def __init__(self):
        super(BattleSummaryScreenView, self).__init__()
        self.messages = dict()
    ...
    def _initialize(self):
        ...
        if InitializeProperty.check_is_ready(self, InitializeState.INITIALIZED):
            ...
            Logs.InfoMessage.simple_info(self, "BattleSummaryScreen.View Initialized [ OK ]")
    ...
    def prepare_messages(self):
        ...
        text_box.property('TransformProperty').position.x = 120

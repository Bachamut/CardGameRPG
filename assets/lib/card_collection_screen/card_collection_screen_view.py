...
class CardCollectionScreenView(GameObject):

    def __init__(self):
        super(CardCollectionScreenView, self).__init__()
        self.messages = dict()
    ...
    def _initialize(self):
        ...
        if InitializeProperty.check_is_ready(self, InitializeState.INITIALIZED):
            ...
            Logs.InfoMessage.simple_info(self, "CardCollectionScreen.View Initialized [ OK ]")
        ...
        if InitializeProperty.check_is_ready(self, InitializeState.STARTED):
            ...
            Logs.InfoMessage.simple_info(self, "CardCollectionScreen.View Started [ OK ]")
    ...
    def prepare_messages(self):
        ...
        text_box.property('TransformProperty').position.x = 220

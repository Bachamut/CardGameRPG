...
class CardView(GameObject):
    ...
    def _on_rise(self):
        ...
        print(f'\nCurrent Character: {self.current_character.take().name}')
        # for card in BattleLogic.current_character.hand:
        #     print(card.card_name)

        step = 0
        for card in self.current_character.take().hand:
    ...
    def _on_fall(self):
        ...
        # print(f'On_Fall')
        print(f'Previous Character: {self.previous_character.take().name}')
